...
- [docs/roadmap/today-discussion-summary.md](docs/roadmap/today-discussion-summary.md) — 대화 기반 과도기 요약
...
- Honcho/session 기록은 대화 맥락 회수용이며 기준 문서를 대체하지 않는다.
...
- `docs/roadmap/` — phase roadmap, active checklist, 과도기 요약
