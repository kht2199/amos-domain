...
- ontology 기준 문서 확정
- domain object / request 상태 canonical 확정
- 실전 원칙 확정
- engine 최소 개념 정리
...
- ontology 큰 그림: `../ontology/foundation-ontology.md`
...
### 현재 진행 순서
1. `../ontology/foundation-ontology.md` 기준으로 도메인 객체/상태 축을 고정하고, `../ontology/agent-request-interpretation.md` 기준으로 request 상태 canonical을 고정
...
- 도메인 객체 ontology와 request 상태 canonical의 ownership이 분리된 채 문서상 고정돼 있다.
...
- foundation 문서군의 역할은 현재 기준으로 분리돼 있다.
  - 큰 그림 / 의미 체계: `../ontology/foundation-ontology.md`
  - 도메인 객체/상태 기준: `../ontology/foundation-ontology.md`
  - request 해석 / request 상태 canonical: `../ontology/agent-request-interpretation.md`
...
### Foundation 남은 작업
1. 각 구현 저장소에 `concept-code-mapping.md` 또는 동등 문서를 두고 `../ontology/foundation-ontology.md` / `../ontology/agent-request-interpretation.md` 기준 대응표를 만든다.
