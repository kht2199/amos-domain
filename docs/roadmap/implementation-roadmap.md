...
### 현재 진행 순서
1. `../ontology/foundation-ontology.md` 기준으로 용어와 상태 canonical 고정
...
### Foundation 남은 작업
1. 각 구현 저장소에 `concept-code-mapping.md` 또는 동등 문서를 두고 `../ontology/foundation-ontology.md` 기준 대응표를 만든다.
